 ...
 * @fn      SystemInit
 *
 * @brief   Initializes the microcontroller system by configuring the
 *          Embedded Flash Interface, setting up the Phase-Locked Loop (PLL)
 *          for the desired system clock frequency, and updating the
 *          SystemCoreClock variable to reflect the current core clock.
 *
 * @return  None
 *********************************************************************/

void SysTick_Init(uint64_t cmp_value) {
    SysTick->CTLR = 0;
