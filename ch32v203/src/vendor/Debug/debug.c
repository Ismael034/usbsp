 ...
 * @fn      SDI_Scanf_Enable
 *
 * @brief   Initializes the SDI scanf Function.
 *
 * @param   None
 *
 * @return  None
 */
void SDI_Scanf_Enable(void)
{
    *(DEBUG_DATA0_ADDRESS) = 0;
    Delay_Init();
    Delay_Ms(1);
 ...
 * @fn      _read
 *
 * @brief   Support Scanf Function
 *
 * @param   *buf - UART send Receive.
 *          size - Data length
 *
 * @return  size: Data length
 */
...
void _read(int fd, char *buf, int *size)
{
    ...
    char character;
    static int line[256];
    static USART_TypeDef *_USART = USART1;
        ...
        do
        {
            ...
            switch (character) {
                ...
                case '\n':
                    ...
                    USART_SendData(_USART, character);
                    break;
                default:
                    USART_SendData(_USART, character);
                    line[i++] = character;
